...
#ifdef SUPLA_SERVO_CUSTOM
    this->addKey(KEY_MAX_SERVO, "0", 2);
    this->addKey(KEY_SERVO_TYPE, "0", 25);
    this->addKey(KEY_SERVO_CH_TYPE, "0", 25);
    this->addKey(KEY_SERVO_INVERTED, "0", 25);
    this->addKey(KEY_SERVO_ZERO, "50", 25);
    this->addKey(KEY_SERVO_MAX_ANGLE, "45", 25);
    this->addKey(KEY_SERVO_SPEED, "100", 25);
    this->addKey(KEY_SERVO_SOFT_START, "0", 25);
    this->addKey(KEY_SERVO_SOFT_STOP, "0", 25);
    this->addKey(KEY_SERVO_OFF_PWM, "0", 25);
    this->addKey(KEY_SERVO_STOP_US, "1500", 25);
    this->addKey(KEY_SERVO_DIR, "0", 25);
    this->addKey(KEY_SERVO_TIME, "0", 25);
    this->addKey(KEY_SERVO_SPEED_DOWN, "100", 25);
    this->addKey(KEY_SERVO_TIME_DOWN, "0", 25);
    this->addKey(KEY_SERVO_OVERDRIVE, "0", 25);
    this->addKey(KEY_SERVO_LIMIT_UP, "255", 25);
    this->addKey(KEY_SERVO_LIMIT_UP_STATE, "0", 25);
    this->addKey(KEY_SERVO_LIMIT_DOWN, "255", 25);
    this->addKey(KEY_SERVO_LIMIT_DOWN_STATE, "0", 25);
#else
    this->addKey(KEY_MAX_SERVO, 2, false);
    this->addKey(KEY_SERVO_TYPE, 25, false);
    this->addKey(KEY_SERVO_CH_TYPE, 25, false);
    this->addKey(KEY_SERVO_INVERTED, 25, false);
    this->addKey(KEY_SERVO_ZERO, 25, false);
    this->addKey(KEY_SERVO_MAX_ANGLE, 25, false);
    this->addKey(KEY_SERVO_SPEED, 25, false);
    this->addKey(KEY_SERVO_SOFT_START, 25, false);
    this->addKey(KEY_SERVO_SOFT_STOP, 25, false);
    this->addKey(KEY_SERVO_OFF_PWM, 25, false);
    this->addKey(KEY_SERVO_STOP_US, 25, false);
    this->addKey(KEY_SERVO_DIR, 25, false);
    this->addKey(KEY_SERVO_TIME, 25, false);
    this->addKey(KEY_SERVO_SPEED_DOWN, 25, false);
    this->addKey(KEY_SERVO_TIME_DOWN, 25, false);
    this->addKey(KEY_SERVO_OVERDRIVE, 25, false);
    this->addKey(KEY_SERVO_LIMIT_UP, 25, false);
    this->addKey(KEY_SERVO_LIMIT_UP_STATE, 25, false);
    this->addKey(KEY_SERVO_LIMIT_DOWN, 25, false);
    this->addKey(KEY_SERVO_LIMIT_DOWN_STATE, 25, false);
#endif

  } // TO JEST KLAMRA ZAMYKAJĄCA if (SPIFFSbegin()). MUSI TU BYĆ!
